...
describe('most likes', () => {
    ...
    const listWithManyBlogsAndOneFavoriteAuthor = [
        {
    ...
    const listWithManyBlogsAndTwoFavoriteAuthors = [
        {
          _id: "5a422a851b54a676234d17f7",
          title: "React patterns",
          author: "Michael Chan",
    ...
    test('of a bigger list with one favorite author equals that author', () => {
        const result = listHelper.mostLikes(listWithManyBlogsAndOneFavoriteAuthor)
